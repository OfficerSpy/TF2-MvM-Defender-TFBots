...
#define ITEMDEF_DEFAULT	-1

public const int WEAPONS_SCOUT_PRIMARY[] = {200, 45, 220, 448, 669, 772, 799, 808, 888, 897, 906, 915, 964, 973, 1078, 1103, 15002, 15015, 15021, 15029, 15036, 15053, 15065, 15069, 15106, 15107, 15108, 15131, 15151, 15157};
public const int WEAPONS_SCOUT_SECONDARY[] = {209, 46, 160, 163, 222, 294, 449, 773, 812, 833, 1121, 1145, 15013, 15018, 15035, 15041, 15046, 15056, 15060, 15061, 15100, 15101, 15102, 15126, 15148, 30666};
public const int WEAPONS_SCOUT_MELEE[] = {190, 44, 221, 264, 317, 325, 349, 355, 423, 450, 452, 474, 572, 648, 660, 880, 939, 954, 999, 1013, 1071, 1123, 1127, 30667, 30758};
public const int WEAPONS_SOLDIER_PRIMARY[] = {205, 127, 228, 237, 414, 441, 513, 658, 730, 800, 809, 889, 898, 907, 916, 965, 974, 1085, 1104, 15006, 15014, 15028, 15043, 15052, 15057, 15081, 15104, 15105, 15129, 15130, 15150};
public const int WEAPONS_SOLDIER_SECONDARY[] = {199, 129, 133, 226, 354, 415, 442, 444, 1001, 1101, 1141, 1153, 15003, 15016, 15044, 15047, 15085, 15109, 15132, 15133, 15152};
public const int WEAPONS_SOLDIER_MELEE[] = {196, 128, 154, 264, 357, 416, 423, 447, 474, 775, 880, 939, 954, 1013, 1071, 1123, 1127, 30758};
public const int WEAPONS_PYRO_PRIMARY[] = {208, 40, 215, 594, 659, 741, 798, 807, 887, 896, 905, 914, 963, 972, 1146, 1178, 15005, 15017, 15030, 15034, 15049, 15054, 15066, 15067, 15068, 15089, 15090, 15115, 15141, 30474};
public const int WEAPONS_PYRO_SECONDARY[] = {199, 39, 351, 415, 595, 740, 1081, 1141, 1153, 1179, 1180, 15003, 15016, 15044, 15047, 15085, 15109, 15132, 15133, 15152};
public const int WEAPONS_PYRO_MELEE[] = {192, 38, 153, 214, 264, 326, 348, 423, 457, 466, 474, 593, 739, 813, 834, 880, 939, 954, 1000, 1013, 1071, 1123, 1127, 1181, 30758};
public const int WEAPONS_DEMOMAN_PRIMARY[] = {206, 308, 405, 608, 996, 1007, 1101, 1151, 15077, 15079, 15091, 15092, 15116, 15117, 15142, 15158};
public const int WEAPONS_DEMOMAN_SECONDARY[] = {207, 130, 131, 265, 406, 661, 797, 806, 886, 895, 904, 913, 962, 971, 1099, 1144, 1150, 15009, 15012, 15024, 15038, 15045, 15048, 15082, 15083, 15084, 15113, 15137, 15138, 15155};
public const int WEAPONS_DEMOMAN_MELEE[] = {191, 132, 154, 172, 264, 266, 307, 327, 357, 404, 423, 474, 482, 609, 880, 939, 954, 1013, 1071, 1082, 1123, 1127, 30758};
public const int WEAPONS_HEAVY_PRIMARY[] = {202, 41, 298, 312, 424, 654, 793, 802, 811, 832, 850, 882, 891, 900, 909, 958, 967, 15004, 15020, 15026, 15031, 15040, 15055, 15086, 15087, 15088, 15098, 15099, 15123, 15124, 15125, 15147};
public const int WEAPONS_HEAVY_SECONDARY[] = {199, 425, 1141, 1153, 15003, 15016, 15044, 15047, 15085, 15109, 15132, 15133, 15152};
public const int WEAPONS_HEAVY_MELEE[] = {195, 43, 239, 264, 310, 331, 423, 426, 474, 587, 656, 880, 939, 1013, 1071, 1084, 1100, 1123, 1127, 1184, 30758};
public const int WEAPONS_ENGINEER_PRIMARY[] = {199, 141, 527, 588, 997, 1004, 1141, 1153, 15003, 15016, 15044, 15047, 15085, 15109, 15132, 15133, 15152};
public const int WEAPONS_ENGINEER_SECONDARY[] = {209, 140, 160, 294, 528, 1086, 15013, 15018, 15035, 15041, 15046, 15056, 15060, 15061, 15100, 15101, 15102, 15126, 15148, 30666, 30668};
public const int WEAPONS_ENGINEER_MELEE[] = {197, 142, 155, 169, 329, 423, 589, 662, 795, 804, 884, 893, 902, 911, 960, 969, 1071, 1123, 15073, 15074, 15075, 15139, 15140, 15114, 15156, 30758};
public const int WEAPONS_MEDIC_PRIMARY[] = {204, 36, 305, 412, 1079};
public const int WEAPONS_MEDIC_SECONDARY[] = {211, 35, 411, 663, 796, 805, 885, 894, 903, 912, 961, 970, 998, 15008, 15010, 15025, 15039, 15050, 15078, 15097, 15121, 15122, 15120, 15145, 15146};
public const int WEAPONS_MEDIC_MELEE[] = {198, 37, 173, 264, 304, 413, 423, 474, 880, 939, 954, 1003, 1013, 1071, 1123, 1127, 1143, 30758};
public const int WEAPONS_SNIPER_PRIMARY[] = {201, 56, 230, 402, 526, 664, 752, 792, 801, 851, 881, 890, 899, 908, 957, 966, 1005, 1092, 1098, 15000, 15007, 15019, 15023, 15033, 15059, 15070, 15071, 15072, 15111, 15112, 15135, 15136, 15154, 30665};
public const int WEAPONS_SNIPER_SECONDARY[] = {203, 57, 58, 231, 642, 751, 1083, 1105, 1149, 15001, 15022, 15032, 15037, 15058, 15076, 15110, 15134, 15153};
public const int WEAPONS_SNIPER_MELEE[] = {193, 171, 232, 264, 401, 423, 474, 880, 939, 954, 1013, 1071, 1123, 1127, 30758};
public const int WEAPONS_SPY_SECONDARY[] = {210, 61, 161, 224, 460, 525, 1006, 1142, 15011, 15027, 15042, 15051, 15062, 15063, 15064, 15103, 15128, 15127, 15149};
public const int WEAPONS_SPY_BUILDING[] = {736, 810, 831, 933, 1080, 1102};
public const int WEAPONS_SPY_MELEE[] = {194, 225, 356, 423, 461, 574, 638, 649, 665, 727, 794, 803, 883, 892, 901, 910, 959, 968, 1071, 15062, 15094, 15095, 15096, 15118, 15119, 15143, 15144, 30758};
public const int WEAPONS_SPY_PDA2[] = {212, 59, 60, 297, 947};
